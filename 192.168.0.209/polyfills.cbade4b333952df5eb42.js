            ...
            Zone.__load_patch("ZoneAwarePromise", (e, t, n) => {
                ...
                function S(e, o, s) {
                    ...
                    if (e[_] === m) {
                        ...
                        if (o !== b && s instanceof I && s.hasOwnProperty(_) && s.hasOwnProperty(k) && s[_] !== m) P(s), S(e, s[_], s[k]);
                ...
                class I {
                    ...
                    static any(e) {
                        if (!e || "function" != typeof e[Symbol.iterator]) return Promise.reject(new z([], "All promises were rejected"));
                        const t = [];
                        let n = 0;
                        try {
                        ...
                        if (0 === n) return Promise.reject(new z([], "All promises were rejected"));
                        let o = !1;
                        const r = [];
                        return new I((e, s) => {
                            for (let i = 0; i < t.length; i++) t[i].then(t => {
                                ...
                                r.push(e), n--, 0 === n && (o = !0, s(new z(r, "All promises were rejected")))
                            })
                        })
                    }
                    static race(e) {
                    ...
                    constructor(e) {
                        const t = this;
                        if (!(t instanceof I)) throw new Error("Must be an instanceof Promise.");
                        t[_] = m, t[k] = [];
                        try {
                            const n = w();
                            e && e(n(E(t, v)), n(E(t, b)))
                ...
                return n.patchThen = N, R && (N(R), C(e, "fetch", e => {
                    return t = e,
                        function(e, n) {
                            let o = t.apply(e, n);
                    ...
                    var t
                })), Promise[t.__symbol__("uncaughtPromiseErrors")] = i, I
